---
id: protocol-network-assembly
type: protocol
protocol_type: group
governs: "[[Network Assembly]]"
triggers: governance-action
kg_entity: "kg://ethboulder/protocol/network-assembly"
---
This protocol governs the operation of the [[Network Assembly]] — all Members exercising governance authority through sociocratic consent.
...
|------|-----------|----------------|
| [[Network Assembly]] | All governance decisions | Constitution |
| [[Member]] | Propose, consent, object | Network Assembly |
| [[Stewardship]] | Facilitate process | Network Assembly |
| [[Participant]] | Raise objections (not counted in quorum) | Community norms |

## What Is Governed

The Network Assembly governs three things:
...
- Schelling Point app governance
...
| **Foundational** | 3-member + 48h | Full network + 72h |

### Boundary Heuristic

**If it creates an expectation or dependency for other participants, it's coordination.**

- Individual: "I'm researching Ethereum localism patterns in other bioregions"
- Coordination: "The Knowledge Circle will handle all entity reconciliation"
- Foundational: "We're changing how the knowledge graph schema works"
...
| 10 | Update knowledge graph | Agent | Automated |
...
- Principle violation: "This contradicts our Ethereum localism principles"
...
Assembly rhythm adjusts to the event cycle:

| Phase | Frequency | Focus |
|-------|-----------|-------|
| **Inter-Event** | Monthly | Normal governance |
| **Pre-Event** | Bi-weekly | Budget, event decisions |
| **Event** | Emergency only | Real-time issues |
| **Post-Event** | Weekly | Retrospective, succession |

### Event-Specific Decisions

| Decision | Timing | Process |
|----------|--------|---------|
| Event budget | Early December | Standard consent |
| Format changes | Inter-Event | Standard consent |
| Fast-track memberships | Post-Event | Standard consent |
| Retrospective actions | Post-Event | Standard consent |
...
All governance decisions are recorded in the knowledge graph:

```cypher
(:Decision {
  id: "kg://ethboulder/decision/[id]",
...
(:Decision)-[:PROPOSED_BY]->(:Person)
(:Decision)-[:CONSENTED_BY]->(:Person)
(:Decision)-[:AFFECTS]->(:Asset|Protocol|Role)
```
...
- [[3. Protocols/Cultural Protocols/Event Cycle Protocol|Event Cycle Protocol]] — Governance rhythm
